...
/**
 * Created by Naresh on 08-09-2016.
 */

public class ZoomFramLayoutView extends FrameLayout {
    ...
    public ZoomFramLayoutView(final Context context) {
        super(context);
        setLayerType(View.LAYER_TYPE_SOFTWARE, null);
    }

    public ZoomFramLayoutView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setLayerType(View.LAYER_TYPE_SOFTWARE, null);
    }
